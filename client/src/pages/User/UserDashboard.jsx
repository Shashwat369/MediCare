...
const UserDashboard = () => {
  ...
  const handleLogout = () => {
    if (window.confirm("Are you sure you want to log out?")) {
      ...
      // 2. Redirect straight to the login page
      navigate("/login");
    }
  };
    ...
    <div className="flex h-screen bg-[#F8FAFC] font-sans">
      ...
      <aside className="w-72 bg-white border-r border-gray-100 hidden md:flex flex-col shadow-sm z-10">
        ...
        <div className="p-4 border-t border-gray-100">
          <button className="w-full flex items-center justify-center gap-2 py-3 bg-red-50 text-red-600 rounded-xl font-semibold hover:bg-red-100 transition-colors" onClick={handleLogout}>
            <svg
              className="w-5 h-5"
              fill="none"
              stroke="currentColor"
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-8 z-10 sticky top-0">
          ...
          <div className="flex items-center gap-6 ml-4">
            {/* --- SHOPPING CART ICON WITH ONCLICK --- */}
            <button
              onClick={() => setIsCartOpen(true)}
              className="relative p-2 text-gray-400 hover:text-green-600 transition-colors group cursor-pointer"
            >
              <svg
                className="w-6 h-6"
                fill="none"
            ...
            <div className="flex items-center gap-3 cursor-pointer">
              ...
              <img
                src="https://ui-avatars.com/api/?name=John+Doe&background=22c55e&color=fff"
                alt="User"
                className="h-10 w-10 rounded-full shadow-sm border-2 border-white"
              />
            </div>
          </div>
        </header>
            ...
            <div className="bg-gradient-to-r from-green-600 to-green-400 rounded-3xl p-8 text-white shadow-lg shadow-green-200 flex justify-between items-center">
              <div className="max-w-md">
                ...
                <p className="text-green-50 mb-6">
                  Upload your prescription and get medicines delivered from
                  nearby pharmacies in minutes.
                </p>
              ...
              <div className="hidden md:block">
                ...
                <svg
                  className="w-32 h-32 text-green-100 opacity-50"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
            ...
            <div>
              ...
              <div className="flex gap-4 overflow-x-auto pb-2">
                {[
                  ...
                  <button
                    key={idx}
                    className="whitespace-nowrap bg-white border border-gray-100 px-5 py-2.5 rounded-xl text-sm font-semibold text-gray-600 hover:border-green-300 hover:text-green-600 hover:shadow-sm transition-all"
                  >
                    {cat}
                  </button>
                ))}
              ...
              <div className="flex justify-between items-end mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Sourced from top pharmacies in Gorakhpur
                  </p>
                </div>
